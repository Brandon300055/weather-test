...
var weather = new vue__WEBPACK_IMPORTED_MODULE_2__.default({
  ...
  methods: {
    fahrenheit: function fahrenheit(temp) {
    ...
    edit: function edit() {
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
        ...
        if (result.value) {
          ...
          _this.zip = result.value;

          _this.getData(result.value);
        }
      });
    },
    ...
    getData: function getData() {
      ...
      var zip = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
      axios__WEBPACK_IMPORTED_MODULE_0___default().get('/get-weather' + (zip ? "?zip=" + zip : "")).then(function (response) {
        console.log(response.data);
        var weatherData = response.data;
        _this2.temp = _this2.fahrenheit(weatherData.main.temp);
        _this2.sky = weatherData.weather[0].main;
        _this2.location = weatherData.name;
        _this2.humidity = weatherData.main.humidity;
        _this2.pressure = weatherData.main.pressure;
        _this2.wind = weatherData.wind.speed;

        _this2.setSky(_this2.sky); // set video and icon this.sky
...
/******/ 	__webpack_require__.O(undefined, ["css/app"], () => (__webpack_require__("./resources/js/pages/welcome.js")))
